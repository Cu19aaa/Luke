      ...
      <div className='w-full h-full bg-[#a6a6a6] py-16 px-4 top-0 left-0 object-cover' style={{ backgroundImage: `url(${handstand})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 relative'>
          ...
          <div className='flex flex-col justify-center text-white'>
            ...
            <h2 className='text-4xl sm:text-5xl font-bold text-Black'>I am a Qualified</h2>
            <ReactTyped className='text-4xl sm:text-5xl font-bold text-orange-600'
              strings={['Personal Trainer', 'Calisthenics Coach', 'Nutritional Therapist']} typeSpeed={120} backSpeed={140} loop />

              <p className='text-[#8892b0] py-4 max-w-[700px]'>I am a personal trainer and calisthenics coach whose goal is to help you reach your fitness goals. </p>
            <div>
              <a href="lukemstratford@gmail.com">
